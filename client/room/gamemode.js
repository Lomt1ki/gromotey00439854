...
const EndOfMatchTime = 800;
const VoteTime = 20;

const KILL_SCORES = 5000;
...
redTeam.Properties.Get(SCORES_PROP_NAME).Value = 100;
blueTeam.Properties.Get(SCORES_PROP_NAME).Value = 100;

// отображаем значения вверху экрана
Ui.GetContext().TeamProp1.Value = { Team: "СССР", Prop: SCORES_PROP_NAME };
Ui.GetContext().TeamProp2.Value = { Team: "USA", Prop: SCORES_PROP_NAME };
